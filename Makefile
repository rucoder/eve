...
# That seems to be the direction taken for existing kvm systems where partition size is 512MB but
# rootfs size is limited to 350MB. That helps in catching image size increases earlier than at later stage.
