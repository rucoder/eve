...
cp -r /sys/fs/cgroup/eve    "$DIR/sys-fs-cgroup-eve" >/dev/null 2>&1
cp /sys/fs/cgroup/eve/memory.events "$DIR/memory-events" >/dev/null 2>&1
cp /sys/fs/cgroup/eve/memory.pressure "$DIR/memory-pressure" >/dev/null 2>&1
